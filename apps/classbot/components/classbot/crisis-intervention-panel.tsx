  ...
  return (
    <>
      <section className="bg-pullim-slate-900 text-pullim-slate-200 rounded-2xl p-5">
        ...
        {students.length === 0 ? (
          <EmptyState tone="plain" size="sm" title="현재 위기 신호 없음" />
        ) : (
              ...
              <li key={s.id}>
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <Heart className="text-pullim-danger h-3 w-3" />
                  </div>
                </button>
              </li>
            ))}
        ...
        <ComingSoonButton note="Wee센터 연계" className="mt-3 w-full rounded-lg py-2 text-xs font-bold bg-pullim-blue-600 hover:bg-pullim-blue-700 text-white inline-flex items-center justify-center">
