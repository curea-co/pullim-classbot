          ...
          <div className="min-w-0 flex-1">
            ...
            {bot.isOfficial ? (
              /*
                ...
                보이는 글자는 두 어절이라 뜻이 좀 줄어드는데, 그건 낭독기 쪽에 한 마디를 더 달아
                메운다. (`07 § 6.6` 「버튼은 단어로」를 근거로 들지 않는다 — 그 조항은 스스로
                **버튼·링크·CTA 라벨**로 범위를 못박고 `§ 6.6.2(4)` 가 그 밖을 대상에서 뺀다.
                이 배지는 그중 어느 것도 아니다. 짧게 쓰고 잃은 뜻을 접근성 이름에 남기는 **모양**만
                같다.)
              */
              <p className="mt-1">
