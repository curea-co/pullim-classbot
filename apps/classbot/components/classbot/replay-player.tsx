    ...
    <section className="from-pullim-slate-900 to-pullim-blue-900 relative overflow-hidden rounded-2xl bg-gradient-to-br p-5 text-white shadow-xl lg:p-6">
      ...
      <div className="relative">
        ...
        {currentLine ? (
          ...
          <div className="bg-white/5 mt-4 rounded-xl p-3.5 text-center text-2xs text-white/50">
  ...
  return (
    <aside className="bg-card rounded-xl border p-4">
      <header className="mb-2 flex items-center gap-1.5">
        ...
        <span className="text-pullim-slate-500 ml-auto text-2xs">AI 자동 추출</span>
      </header>
    ...
    <section className="bg-card rounded-2xl border p-4">
      <header className="mb-2.5 flex items-center justify-between">
        <div>
          ...
          <p className="text-pullim-slate-500 text-2xs">1분 단위 · 클릭 시 그 시점으로</p>
        </div>
        <span className="text-pullim-slate-400 font-mono text-micro">0~100</span>
      </header>
    ...
    <section className="bg-card rounded-2xl border p-4">
      <header className="mb-3 flex items-start justify-between gap-2">
        <div>
          ...
          <p className="text-pullim-slate-500 text-2xs">여기 다시 듣고 싶을 때 저장</p>
        </div>
        <Button
          type="button"
          variant="ghost"
          ...
          {bookmarks.map(b => (
            <li key={b.id}>
              ...
              >
                ...
                <span className="text-pullim-slate-500 text-2xs">{b.createdAt}</span>
              </button>
            </li>
          ))}
        </ul>
  ...
  return (
    <section className="bg-card rounded-2xl border p-4">
      <header className="mb-3">
        ...
        <p className="text-pullim-slate-500 text-2xs">개인 메시지 — 다른 학생은 못 봐요</p>
      </header>
      ...
      >
        <span className="bg-pullim-blue-50 text-pullim-blue-700 shrink-0 rounded font-mono text-micro font-bold px-1.5 py-1">
          @{formatReplayTime(now)}
        </span>
        <Input
          type="text"
          ...
          {questions.map(q => (
            <li key={q.id} className="bg-pullim-slate-50/60 rounded-lg p-2.5 text-xs">
              ...
              {q.status === 'replied' && q.reply && (
                <div className="bg-pullim-blue-50 mt-2 rounded p-2 text-2xs">
