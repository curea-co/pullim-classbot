 ...
 *
 * 1/6 은 학부모 줄을 뺐다 — 서버 allowlist 에 학부모 **명의**는 이미 서 있었지만 갈
 * **화면**이 없어, 실으면 누르는 즉시 404 였기 때문이다. 그 화면(`/parent`)이 이 PR 에서
...
/** 드롭다운에 펴는 계정 — 착지점이 있는 역할의 계정만(이 PR 부터는 allowlist 전원). */
