 ...
 *
 * 주간 리포트(`/classbot/me/report`)와 역할이 다르다는 구분은 그대로다 — 그쪽은 한 주의
 * **컨디션**(웰빙 게이지)을 보고, 여기는 성취기준 한 줄 단위로 파고든다. 그래서 같은 숫자를
 * 두 번 보여주지 않는다.
 * *(`[2026-09-18 정정]` 종전에는 그쪽을 「한 주를 봇 목소리로 요약한다」로 적었다. 그 요약
 * 칸들(잘한 점 · 신경 쓸 점 · 「이번 주 지표」)은 보는 사람을 두고 단정하는데 셀 곳이 없어
 * 걷혔다 — 무엇을 왜 걷었는지는 그 화면의 머리주석에 있다.)*
 */
