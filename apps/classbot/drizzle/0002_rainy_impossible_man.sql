...
ALTER TABLE "assignments" ADD COLUMN "target_student_ids" jsonb;--> statement-breakpoint
ALTER TABLE "assignments" ADD COLUMN "dispatched_at" timestamp with time zone DEFAULT now();--> statement-breakpoint
