...
- **런타임/패키지 매니저**: Bun
- **웹 개발**: Next.js (App Router) + TypeScript + TailwindCSS
- **데이터 처리**: Bun 스크립트 (`src/`)
...
1. 다른방식으로 프로젝트를 생성합니다.
   ...
   Next.js + TypeScript 프로젝트를 한개 생성합니다 (App Router 기반).
   
   ```bash
   bunx create-next-app@latest . --typescript --app --tailwind --eslint --src-dir --use-bun
   ```
