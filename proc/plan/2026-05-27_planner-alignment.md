...
│   │   │   │   └── teacher-assignment/      # 교사 과제 출제 (/teacher/assignment/new — spec IA 외 실제 구현 라우트)
...
- **Phase θ 진입 전까지 Playwright spec 영향 없음** (mock 제거는 Phase θ — 그 전 Phase ζ·η 는 Container/Presenter 구조 분리만이라 mock 의존성·spec 무변경)
