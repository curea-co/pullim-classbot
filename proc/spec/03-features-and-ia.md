...
길이 하나라 「어디로 갈지」를 먼저 고르게 하지 않는다. 마당 셋을 지나며 채우되, **어느 마당에서든** 「만들기」로 끝낼 수 있다 — 그 버튼은 **페이지 헤더 오른쪽에 늘 있다.** *(2026-08-24 이름 변경 — 종전 「이대로 만들기」. 버튼은 단어로: [07 § 6.6](07-branding.md))*
...
| 만든 뒤 화면 | — | 봇 배정할 반 고르기 + 「채워진 것」 재표시 + 「봇 운영」 / 「고치기」 / 「새 봇」 |
