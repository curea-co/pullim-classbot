...
> 권위 문서 두 개를 함께 갱신했다 — **2026-08-24 재편(#227·#228)** 이 핸드오프 § 4.1 과 `05_풀림_수업방_세부기획.md` § 8.1 · § 8.2 · § 13 을 맞췄다 (둘 다 사용자 명시 승인, 그 자리로 한정). 권위 묶음이 한 정의를 가리킨다. *(그 뒤 「버튼 이름을 단어로」 개정은 핸드오프 § 4.1 과 `05_...` § 8.1 만 건드린다.)*
