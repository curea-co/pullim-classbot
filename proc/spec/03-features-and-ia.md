...
> **2026-08-24 개정 — 8단계 위저드를 한 길 · 세 마당으로 대체 (PR #223).**
> 아래 **「없어진 것」의 빌더발 코드·링크·QR · 루브릭 진실원 · 임시저장**은 재편 이전에도 구현돼 있지 않았다 — 종전 문서가 미구현을 구현된 것처럼 적고 있었다.
