...
| 봇 빌더 (교사) | `/teacher/builder` | 🟢 | **한 길 · 세 마당** (#223, 03 § 4.3) — 「한 길 · 세 마당」(봇 소개 · 보고 답할 것 · 가르치는 법) + 만든 뒤 화면(반 배정) · 과목만 필수 · 점프 대상 8 → 3 · 「채워진 것」 아홉 가지 카운터 · 목소리·루브릭·임시저장·빌더 내 시간대 Scope 스위치 제거 |
