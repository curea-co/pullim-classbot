...
| 봇 빌더 (교사) | `/teacher/builder` | 🟢 | **현행**: 8단계 위저드(정체성·목소리·교안·수업방식·Scope·평가·안전·배포). StepIndicator 점프 + 임시저장 + Step6 루브릭 합 100% 검증. **재편 인도 중 (#223, 03 § 4.3)**: 「한 길 · 세 마당」(봇 소개 · 보고 답할 것 · 가르치는 법) + 만든 뒤 화면(반 배정) · 과목만 필수 · 점프 대상 8 → 3 · 「채워진 것」 아홉 가지 카운터 · 목소리·루브릭·임시저장·빌더 내 시간대 Scope 스위치 제거 |
