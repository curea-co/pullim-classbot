...
| 봇 빌더 (교사) | `/teacher/builder` | 🟢 | **한 길 · 세 마당**(봇 소개 · 보고 답할 것 · 가르치는 법) + 만든 뒤 화면(반 배정). 꼭 골라야 하는 것은 과목 하나 — 어느 마당에서든 「이대로 만들기」. 단계 점프 유지(8 → 3), 「채워진 것」 아홉 가지 카운터. 목소리·루브릭·임시저장·시간대 Scope 스위치는 없앰 (2026-08-24, 03 § 4.3) |
